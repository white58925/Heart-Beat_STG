...
public class GlitchEffect : MonoBehaviour
{
	...
	void Start()
	{
		//displacementMap = Texture2D.normalTexture;
		_material = new Material(Shader);

		MakeGlitchEffect();
    }
	private void SetGlitchValue()
    {
		glitchValue = Conductor.instance.noiseVolume;
		intensity = glitchValue;
		flipIntensity = glitchValue;
		colorIntensity = glitchValue;
	}
	private void Update()
    {
        MakeGlitchEffect();
